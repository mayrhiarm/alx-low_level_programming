...
/**
 * check_elf - a func to checks if a file is an ELF file.
 ...
 * @e_ident: this is a pointer to an array containing the ELF magic numbers.
 * Description: the magic numbers that are separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @argc: the argument counts supplied to the program.
